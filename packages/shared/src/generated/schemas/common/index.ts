...
export interface TopReworkReason {
   ...
   */
  count: number;
  /** Source of the reason: 'rework' or 'calibration' */
...
/**
 * TopReworkReasonSource
 */
export type TopReworkReasonSource = typeof TopReworkReasonSource[keyof typeof TopReworkReasonSource];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TopReworkReasonSource = {
  rework: 'rework',
  calibration: 'calibration',
} as const;
...
export interface TopReworkReasons {
  /**
   * List of top reasons for rework/calibration
   * @maxItems 10
   */
  reasons?: TopReworkReason[];
  /**
   * Total assessments that had rework
   * @minimum 0
   */
  total_rework_assessments: number;
  /**
   * Total assessments that had calibration
   * @minimum 0
   */
