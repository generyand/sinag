...
- System identifies and displays common correction patterns (e.g., "80% changes related to missing
  MOVs")
...
- [ ] **3.1 Story: Backend Gap Analysis Service**
  ...
  - **Files:** `apps/api/app/services/gap_analysis_service.py`, `apps/api/app/schemas/analytics.py`
    (extend)
...
- [ ] **3.7 Story: Gap Analysis Testing**
  ...
  - [ ] **3.7.1 Atomic:** Write backend gap analysis service tests
    ...
    - **Acceptance:**
      ...
      - Test comparison logic: indicator changed from incomplete → complete, complete → incomplete,
        text changed, MOV count changed
