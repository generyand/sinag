...
class TestMaliciousFileUploadSecurity:
    ...
    def test_reject_executable_content_in_pdf(
        ...
        data = response.json()
        assert "executable" in data.get("error", data.get("detail", "")).lower() or "security" in data.get("error", data.get("detail", "")).lower()
    ...
    def test_reject_script_file_with_valid_extension(
        ...
        assert response.status_code == 400
        data = response.json()
        assert "file type" in data.get("error", data.get("detail", "")).lower() or "not supported" in data.get("error", data.get("detail", "")).lower()
    ...
    def test_reject_zip_bomb_attempt(
        ...
        assert response.status_code == 400
        data = response.json()
        assert "size" in data.get("error", data.get("detail", "")).lower() or "large" in data.get("error", data.get("detail", "")).lower()
    ...
    def test_extension_mismatch_detection(
        ...
        assert response.status_code == 400
        data = response.json()
        assert "mismatch" in data.get("error", data.get("detail", "")).lower() or "content" in data.get("error", data.get("detail", "")).lower()
