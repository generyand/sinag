...
def upgrade() -> None:
    ...
    if 'upload_instructions' in form_schema:
        form_schema['upload_instructions'] = form_schema['upload_instructions'].replace(OLD_LABEL, NEW_LABEL)
...
def downgrade() -> None:
    ...
    if 'upload_instructions' in form_schema:
        form_schema['upload_instructions'] = form_schema['upload_instructions'].replace(NEW_LABEL, OLD_LABEL)
