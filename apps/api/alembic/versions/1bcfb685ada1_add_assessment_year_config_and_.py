...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_assessment_year_configs_current_assessment_year"),
        "assessment_year_configs",
        ["current_assessment_year"],
        unique=False,
    )
    op.create_index(
        op.f("ix_assessment_year_configs_id"), "assessment_year_configs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_assessment_year_configs_is_active"),
        "assessment_year_configs",
        ["is_active"],
        unique=False,
    )
    ...
    op.create_table(
        "assessment_indicator_snapshots",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_assessment_indicator_snapshots_assessment_id"),
        "assessment_indicator_snapshots",
        ["assessment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_assessment_indicator_snapshots_id"),
        "assessment_indicator_snapshots",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_assessment_indicator_snapshots_indicator_id"),
        "assessment_indicator_snapshots",
        ["indicator_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_assessment_indicator_snapshots_indicator_id"),
        table_name="assessment_indicator_snapshots",
    )
    op.drop_index(
        op.f("ix_assessment_indicator_snapshots_id"), table_name="assessment_indicator_snapshots"
    )
    op.drop_index(
        op.f("ix_assessment_indicator_snapshots_assessment_id"),
        table_name="assessment_indicator_snapshots",
    ...
    op.drop_index(
        op.f("ix_assessment_year_configs_is_active"), table_name="assessment_year_configs"
    )
    op.drop_index(op.f("ix_assessment_year_configs_id"), table_name="assessment_year_configs")
    op.drop_index(
        op.f("ix_assessment_year_configs_current_assessment_year"),
        table_name="assessment_year_configs",
    )
