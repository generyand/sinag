...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('item_id', sa.String(20), nullable=False, comment='Unique item identifier (e.g., "1_1_1_a")'),
        sa.Column('label', sa.Text(), nullable=False, comment='Display text (e.g., "a. Barangay Financial Report")'),
        sa.Column('group_name', sa.String(100), nullable=True, comment='Group header (e.g., "ANNUAL REPORT")'),
