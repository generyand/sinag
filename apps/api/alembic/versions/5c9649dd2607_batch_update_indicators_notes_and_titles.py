    ...
    add_notes_only(
        ...
        "4.5.5",
        {
            ...
            "items": [
                {
                    "label": "a)",
                    "text": "Presence of updated Localized Flow Chart of Referral System not earlier than CY 2020;",
                },
                {
                    "label": "b)",
                    "text": "Presence of Comprehensive Barangay Juvenile Intervention Program (For profiling); and",
                },
                {
                    "label": "c)",
                    "text": "Presence of Children at Risk (CAR) and Children in Conflict with the Law (CICL) registry (For profiling).",
                },
            ],
        },
    )
    ...
    add_notes_only(
        ...
        "4.8.1",
        {
            ...
            "items": [
                ...
                {
                    "label": "2.",
                    "text": "President of the Rural Improvement Club (RIC)",
                },
                {
                    "label": "3.",
