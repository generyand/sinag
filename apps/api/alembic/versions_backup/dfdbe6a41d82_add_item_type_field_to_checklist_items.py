...
def upgrade() -> None:
    ...
    op.add_column('checklist_items', sa.Column('item_type', sa.String(length=30), server_default='checkbox', nullable=False))
    ...
    op.alter_column('checklist_items', 'label',
    ...
    op.alter_column('checklist_items', 'mov_description',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               comment=None,
               existing_comment='Means of Verification description',
               existing_nullable=True)
    op.alter_column('checklist_items', 'required',
               existing_type=sa.BOOLEAN(),
               comment=None,
               existing_comment='Required for indicator to pass',
               existing_nullable=False,
               existing_server_default=sa.text('true'))
    op.alter_column('checklist_items', 'requires_document_count',
               existing_type=sa.BOOLEAN(),
               comment=None,
               existing_comment='Needs document count input',
               existing_nullable=False,
               existing_server_default=sa.text('false'))
    op.alter_column('checklist_items', 'display_order',
    ...
    op.create_index(op.f('ix_checklist_items_indicator_id'), 'checklist_items', ['indicator_id'], unique=False)
    op.alter_column('indicator_drafts', 'data',
    ...
    op.create_index(op.f('ix_indicator_drafts_governance_area_id'), 'indicator_drafts', ['governance_area_id'], unique=False)
    op.create_index(op.f('ix_indicator_drafts_user_id'), 'indicator_drafts', ['user_id'], unique=False)
    op.alter_column('indicators', 'mov_checklist_items',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True)
    op.alter_column('indicators', 'validation_rule',
               existing_type=sa.VARCHAR(length=50),
               comment=None,
               existing_comment='Validation strategy',
               existing_nullable=False,
               existing_server_default=sa.text("'ALL_ITEMS_REQUIRED'::character varying"))
    op.alter_column('indicators', 'is_bbi',
               existing_type=sa.BOOLEAN(),
               comment=None,
               existing_comment='Is this a BBI indicator',
               existing_nullable=False,
               existing_server_default=sa.text('false'))
    op.alter_column('indicators', 'effective_date',
               existing_type=sa.DATE(),
               type_=sa.DateTime(),
               comment=None,
               existing_comment='When this version became active',
               existing_nullable=True)
    op.alter_column('indicators', 'retired_date',
               existing_type=sa.DATE(),
               type_=sa.DateTime(),
               comment=None,
               existing_comment='When this version was retired',
               existing_nullable=True)
    op.alter_column('indicators_history', 'mov_checklist_items',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True)
    ...
    op.create_index(op.f('ix_mov_files_assessment_id'), 'mov_files', ['assessment_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.create_index(op.f('idx_mov_files_assessment_id'), 'mov_files', ['assessment_id'], unique=False)
    op.alter_column('indicators_history', 'mov_checklist_items',
    ...
    op.create_index(op.f('idx_indicator_drafts_user'), 'indicator_drafts', ['user_id'], unique=False)
    op.create_index(op.f('idx_indicator_drafts_governance_area'), 'indicator_drafts', ['governance_area_id'], unique=False)
    op.alter_column('indicator_drafts', 'data',
               existing_type=sa.JSON(),
               type_=postgresql.JSONB(astext_type=sa.Text()),
               existing_nullable=False,
    ...
    op.create_index(op.f('idx_checklist_items_indicator'), 'checklist_items', ['indicator_id'], unique=False)
    op.create_index(op.f('idx_checklist_items_group'), 'checklist_items', ['group_name'], unique=False)
    op.alter_column('checklist_items', 'display_order',
               existing_type=sa.INTEGER(),
    ...
    op.create_index(op.f('idx_assessments_rework_requested_by'), 'assessments', ['rework_requested_by'], unique=False)
    # ### end Alembic commands ###
