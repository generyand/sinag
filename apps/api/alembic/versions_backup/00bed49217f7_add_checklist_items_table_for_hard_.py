...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            comment="Item type: checkbox, info_text, etc.",
        ),
        sa.Column(
            "group_name",
            sa.String(255),
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=True,
            comment="Option group for OR logic",
        ),
    ...
    op.execute(
        "UPDATE indicators SET validation_rule = 'ALL_ITEMS_REQUIRED' WHERE validation_rule IS NULL"
    )
