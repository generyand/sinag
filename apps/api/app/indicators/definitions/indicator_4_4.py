    ...
    children=[
        ...
        SubIndicator(
            ...
            upload_instructions=(
                ...
                "designating a KDO to manage the Kasambahay Desk, signed by the PB, Barangay Secretary and SBMs covering January to October 2023"
            ),
            ...
            checklist_items=[
                ChecklistItem(
                    ...
                    mov_description="Executive Order or similar issuance designating Kasambahay Desk Officer covering January to October 2023",
                    required=True,
                    display_order=1
                ),
            ]
        ...
        SubIndicator(
            ...
            upload_instructions=(
                "Upload the following document:\n\n"
                "• Copy of the Updated Kasambahay Report for the 3rd Quarter (July-September 2023)\n\n"
                "Please supply the number of documents submitted:\n"
                "• ___ Kasambahay Reports were submitted"
            ),
            validation_rule="ALL_ITEMS_REQUIRED",
            checklist_items=[
                ChecklistItem(
                    ...
                    mov_description="Updated Kasambahay Report for the 3rd Quarter covering July-September 2023",
                    required=True,
                    display_order=1
                ),
                ChecklistItem(
                    ...
                    mov_description="Input field for number of Kasambahay Reports submitted",
                    required=True,
