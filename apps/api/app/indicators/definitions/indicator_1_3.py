...
INDICATOR_1_3 = Indicator(
    ...
    children=[
        ...
        SubIndicator(
            ...
            upload_instructions=(
                "Upload the Approved Barangay Appropriation Ordinance with the following requirements:\n\n"
                "1. The ordinance must be approved on or before December 31, 2022\n"
                "   - Consideration: Approval until March 31, 2023 will be accepted\n\n"
                "2. The ordinance must be signed by ALL of the following:\n"
                "   - Sangguniang Barangay Members (SBMs)\n"
                "   - SK Chairperson\n"
                "   - Barangay Secretary\n"
                "   - Punong Barangay\n\n"
                "3. Ensure the date of approval is clearly visible on the document"
            ),
            ...
            checklist_items=[
                ChecklistItem(
                    ...
                    mov_description=(
                        ...
                        "1. Barangay Appropriation Ordinance is present\n"
                        "2. Document contains signatures from:\n"
                        "   - All Sangguniang Barangay Members (SBMs)\n"
                        "   - SK Chairperson\n"
                        "   - Barangay Secretary\n"
                        "   - Punong Barangay\n"
                        "3. Input the Date of Approval from the ordinance\n"
                        "   - Primary deadline: On or before December 31, 2022\n"
                        "   - Grace period: Approval until March 31, 2023\n\n"
                        "NOTE: The date of approval will determine compliance status:\n"
                        "- On or before Dec 31, 2022: Full compliance (PASSED)\n"
                        "- Jan 1 - Mar 31, 2023: Considered compliance (CONSIDERED)\n"
                        "- After Mar 31, 2023: Non-compliance (FAILED)"
                    ),
                    required=True,
