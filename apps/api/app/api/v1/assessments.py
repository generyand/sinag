...
def submit_for_calibration_review(
    ...
    rework_responses = [
        ...
        if r.requires_rework and r.indicator and r.indicator.governance_area_id in calibrated_area_ids
    ]
    ...
    if not rework_responses:
        ...
        for response in rework_responses:
            ...
            area_calibration_time = calibration_timestamps_by_area.get(area_id, default_calibration_time)
            ...
            if area_calibration_time and indicator_movs:
                ...
                has_calibration_feedback = feedback_after_calibration > 0 or annotation_after_calibration > 0
