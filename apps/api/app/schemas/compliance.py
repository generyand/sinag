...
class SubIndicatorStatus(BaseModel):
    ...
    validation_status: Literal["PASS", "FAIL", "CONDITIONAL"] | None = None  # Actual confirmed status
    recommended_status: Literal["PASS", "FAIL"] | None = None  # Auto-calculated recommendation (glow)
