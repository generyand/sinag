    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div role="group" aria-labelledby="efficiency-metrics-title">
          <h4
            id="efficiency-metrics-title"
            className="text-lg font-semibold text-[var(--foreground)] mb-4 flex items-center gap-2"
          >
            <div
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs" style={{ color: "var(--kpi-blue-text)" }}>
                    Days
                  </div>
                </div>
              </div>
