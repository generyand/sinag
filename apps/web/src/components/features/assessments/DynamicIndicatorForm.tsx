                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            <p className="text-base font-medium text-[var(--foreground)]">
                              <span className="text-[var(--cityscape-yellow-dark)] font-bold hover:underline">
                                Click to upload
                              </span>{" "}
                              or drag and drop
                            </p>
                        ...
                        return state?.active ? (
                          <div className="mt-4 p-4 bg-[var(--muted)]/30 rounded-lg border border-[var(--border)]">
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-xs font-bold uppercase tracking-wide text-[var(--foreground)]">
                                Uploading files...
                              </span>
                    ...
                    <div className="p-6">
                      <div className="space-y-4">
                        <input
                          ...
                          onChange={async (e) => {
                            const sectionKey =
                              (field as any).mov_upload_section || "unknown_section";
                            startSectionProgress(sectionKey);
                            const files = e.currentTarget.files;
                            console.log(
                              "📁 FILES SELECTED (2):",
                                          ...
                                          updateAssessmentData((prev) => {
                                            ...
                                            const updateInTree = (nodes: any[]): boolean => {
                                              for (let i = 0; i < nodes.length; i++) {
                                                if (String(nodes[i].id) === String(indicatorId)) {
                                                  const current = nodes[i];
                                                  const existing = (current.movFiles ||
                                                    []) as any[];
