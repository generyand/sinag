...
export function ResubmitAssessmentButton({
  ...
  // Different button text and styling based on calibration mode
  const buttonText = isCalibrationRework ? "Submit for Calibration" : "Resubmit Assessment";
  const loadingText = isCalibrationRework ? "Submitting..." : "Resubmitting...";
  const ButtonIcon = isCalibrationRework ? RefreshCw : RotateCcw;
  ...
  // Different dialog content based on calibration mode
  const dialogTitle = isCalibrationRework ? "Submit for Calibration Review?" : "Resubmit Assessment?";
  const dialogDescription = isCalibrationRework
            ...
            >
              {isPending ? (
                ...
                <>
                  ...
                  {isCalibrationRework ? "Confirm Submit" : "Confirm Resubmit"}
                </>
              )}
            </AlertDialogAction>
          </AlertDialogFooter>
