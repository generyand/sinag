        ...
        <CardContent className="relative z-10 p-4 sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-3 sm:gap-4">
              <div
                className={cn(
                  "p-3 sm:p-4 rounded-sm shadow-md flex-shrink-0",
                  hasActionsRequired ? "bg-amber-500" : "bg-green-500"
                )}
              >
                {hasActionsRequired ? (
                  <ClipboardCheck className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
                ) : (
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-gray-600 mt-1 sm:mt-1.5">
                  {hasActionsRequired
                    ? "Tap to review and approve pending assessments"
            ...
            <div
              className={cn(
                "flex items-center justify-center gap-2 px-4 py-3 sm:py-2 rounded-sm font-medium transition-colors w-full sm:w-auto sm:flex-shrink-0 min-h-[44px]",
                hasActionsRequired
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Card
                className="relative overflow-hidden border border-[var(--border)] shadow-md bg-gradient-to-br from-blue-50 via-blue-50 to-indigo-50 cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all duration-300 min-h-[44px]"
              ...
              >
                ...
                <CardContent className="p-4 sm:p-5 relative z-10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 mb-3">Barangays have submitted</p>
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      <span className="text-gray-500">Progress</span>
                      <span className="font-semibold text-blue-600">{submissionProgress}%</span>
                    </div>
                    <Progress value={submissionProgress} className="h-2.5 sm:h-2 bg-blue-100" />
                  </div>
                </CardContent>
              </Card>
            </TooltipTrigger>
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Card
                className="relative overflow-hidden border border-[var(--border)] shadow-md bg-gradient-to-br from-purple-50 via-purple-50 to-indigo-50 cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all duration-300 min-h-[44px]"
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Card
                className={cn(
                  "relative overflow-hidden border border-[var(--border)] shadow-md cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all duration-300 min-h-[44px] sm:col-span-2 lg:col-span-1",
                  completed > 0
