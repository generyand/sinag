...
export function SubmissionsFilters({ filters, onFiltersChange }: SubmissionsFiltersProps) {
  ...
  return (
    <div className="space-y-6" role="search" aria-label="Submission filters">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="relative lg:col-span-2">
          <div className="relative">
            <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[var(--text-muted)]" aria-hidden="true" />
            <Input
        ...
        <div className="relative">
          ...
          >
            ...
            {filters.status.length > 0 && (
              <Badge variant="secondary" className="ml-2 bg-[var(--cityscape-yellow)] text-[var(--cityscape-accent-foreground)] rounded-sm" aria-hidden="true">
          ...
          {showStatusFilter && (
            <div id="status-filter-menu" className="absolute top-full left-0 right-0 mt-2 bg-[var(--card)] border-2 border-[var(--border)] rounded-sm shadow-xl z-10 p-4" role="menu" aria-label="Status filter options">
      ...
      {hasActiveFilters && (
        <div className="bg-gradient-to-r from-[var(--muted)] to-[var(--card)] border border-[var(--border)] rounded-sm p-4" role="region" aria-label="Active filters">
