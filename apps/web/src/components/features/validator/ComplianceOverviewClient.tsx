      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Review and confirm compliance status for each sub-indicator based on your validation
            results.
          </p>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm">
              <p className="text-indigo-800 dark:text-indigo-200">
                ...
                status. All indicators start as{" "}
        ...
        <div className="space-y-6">
          {governance_areas.map((area) => (
            <div
              ...
              className="bg-white dark:bg-slate-800/50 rounded-sm border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden"
            >
              {/* Area Header */}
                      ...
                      <div>
                        {indicator.is_bbi ? (
                          indicator.all_validated && indicator.bbi_functionality_level ? (
                            ...
                            >
                              {BBI_LEVEL_CONFIG[
                                indicator.bbi_functionality_level as keyof typeof BBI_LEVEL_CONFIG
                              ]?.label || indicator.bbi_functionality_level}
                            </Badge>
                          ) : (
                            <Badge
                              variant="outline"
                              className="bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700 px-3 py-1"
                            >
                      ...
                      <div className="bg-slate-50 dark:bg-slate-800/30 rounded-sm p-3">
                        ...
                        <div className="space-y-1">
                          {indicator.sub_indicators.map((sub) => {
                            ...
                            const isUnmetRecommended =
                              sub.recommended_status === "FAIL" && !isConfirmed;
