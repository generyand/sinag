          ...
          <Card className="h-full">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className={cn('text-sm', !isPaletteOpen && 'hidden')}>
                  MOV Item Types
                </CardTitle>
                <Button
                  variant="ghost"
          ...
          <CardContent className="flex-1 overflow-auto">
            {config.items.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center p-8">
                ...
                <p className="text-sm text-muted-foreground mb-2">No MOV items yet</p>
                          ...
                          {(provided, snapshot) => {
                            ...
                            return (
                              <div
                                ...
                                className={cn(
                                  'flex items-start gap-2 p-3 rounded-md border bg-card',
