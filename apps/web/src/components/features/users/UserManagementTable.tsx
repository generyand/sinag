        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
          ...
          <div className="flex-1 space-y-2">
            <div className="flex items-center gap-3">
              ...
              >
                <span className="text-base font-bold" style={{ color: "var(--kpi-blue-text)" }}>
                  ...
                  backgroundColor:
                    user.role === "MLGOO_DILG"
                      ...
                      : user.role === "VALIDATOR"
                        ...
                        : user.role === "ASSESSOR"
                          ? "var(--analytics-info-bg)"
                          : "var(--kpi-blue-from)",
                  color:
                    user.role === "MLGOO_DILG"
                      ? "var(--kpi-purple-text)"
                      : user.role === "VALIDATOR"
                        ? "var(--analytics-warning-text)"
                        : user.role === "ASSESSOR"
                          ? "var(--analytics-info-text)"
                          : "var(--kpi-blue-text)",
                  borderColor:
                    user.role === "MLGOO_DILG"
                      ? "var(--kpi-purple-border, var(--border))"
                      : user.role === "VALIDATOR"
                        ? "var(--analytics-warning-border)"
                        : user.role === "ASSESSOR"
                          ? "var(--analytics-info-border)"
