...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-full bg-white/50 p-2 opacity-70 transition-opacity hover:opacity-100 hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
