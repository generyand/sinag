...
describe('GlobalError (Root Error Page)', () => {
  ...
  describe('Error Variants', () => {
    ...
    it('should handle long error messages', () => {
      const longError = {
        ...mockError,
        message: 'This is a very long error message that contains a lot of details about what went wrong in the application and should be displayed properly without breaking the layout',
      };
      process.env.NODE_ENV = 'development';
