...
export const queryKeys = {
  ...
  dashboard: {
    ...
    assessor: (userId?: number) => [...queryKeys.dashboard.all, "assessor", userId] as const,
    validator: (userId?: number) => [...queryKeys.dashboard.all, "validator", userId] as const,
  ...
  governanceAreas: {
    ...
    detail: (id: number) => [...queryKeys.governanceAreas.details(), id] as const,
  ...
  bbis: {
    ...
    list: (filters?: Record<string, unknown>) => [...queryKeys.bbis.lists(), filters] as const,
    details: () => [...queryKeys.bbis.all, "detail"] as const,
    detail: (id: number) => [...queryKeys.bbis.details(), id] as const,
    results: (assessmentId: number) => [...queryKeys.bbis.all, "results", assessmentId] as const,
  },
  ...
  movs: {
    ...
    list: (filters?: Record<string, unknown>) => [...queryKeys.movs.lists(), filters] as const,
    ...
    annotations: (fileId: number) => [...queryKeys.movs.all, "annotations", fileId] as const,
  },
  ...
  submissions: {
    ...
    mlgoo: (filters?: Record<string, unknown>) => queryKeys.submissions.queue("mlgoo", filters),
  },
  ...
  analytics: {
    ...
    externalDashboard: () => [...queryKeys.analytics.external(), "dashboard"] as const,
  },
  ...
  barangays: {
    ...
    list: (filters?: Record<string, unknown>) => [...queryKeys.barangays.lists(), filters] as const,
  ...
  lookups: {
    ...
    governanceAreas: () => [...queryKeys.lookups.all, "governance-areas"] as const,
