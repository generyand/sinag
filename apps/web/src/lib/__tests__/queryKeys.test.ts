...
describe("queryKeys", () => {
  ...
  describe("Submissions Keys", () => {
    ...
    it("should return correct submissions.mlgoo key", () => {
      expect(queryKeys.submissions.mlgoo()).toEqual(["submissions", "queue", "mlgoo", undefined]);
    });
  });
  ...
  describe("Analytics Keys", () => {
    ...
    it("should return correct analytics.governanceArea key", () => {
      expect(queryKeys.analytics.governanceArea(2)).toEqual(["analytics", "governance-area", 2]);
    });
...
describe("queryConfigs", () => {
  ...
  describe("Config Comparison", () => {
    it("should have realtime config more aggressive than standard", () => {
      expect(queryConfigs.realtime.staleTime).toBeLessThan(queryConfigs.standard.staleTime);
