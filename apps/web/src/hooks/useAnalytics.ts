    ...
    discrepancies: [
      {
        ...
        supervisorRemarks:
          "Documentation issues discovered during final validation that were not captured in pre-assessment",
      },
      {
        ...
        supervisorRemarks:
          "Barangay made significant improvements between pre-assessment and final validation",
      },
    ],
  },
  systemicWeakness: {
...
const analyticsKeys = {
  ...
  officialPerformance: (period: string) =>
    [...analyticsKeys.all, "official-performance", period] as const,
  crossMatching: (period: string) => [...analyticsKeys.all, "cross-matching", period] as const,
  systemicWeakness: (period: string) =>
    [...analyticsKeys.all, "systemic-weakness", period] as const,
