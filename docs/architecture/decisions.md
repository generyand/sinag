...
This file tracks all major technical decisions made in the SINAG project. Each decision includes
context, the choice made, and reasoning.
...
**Context:** Need to manage a full-stack application with TypeScript frontend and Python backend
while sharing types and utilities.
...
**Context:** Need to keep TypeScript and Python types synchronized without creating maintenance
nightmares.
